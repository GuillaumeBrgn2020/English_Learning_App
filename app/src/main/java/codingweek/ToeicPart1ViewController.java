...
public class ToeicPart1ViewController implements Initializable{

    private ArrayList <ToeicPartOneQuestion> questions;
    ...
    public ToeicPart1ViewController(String nameSerie) {
        this.nameSerie = nameSerie;
        try {       
            File file = new File(getClass().getResource("saves/toeicPartOne" + this.nameSerie + ".json").toURI().getRawPath());
            // create a reader
            FileReader reader = new FileReader(file.getAbsolutePath());
            // convert JSON array to list of users
            this.questions = new Gson().fromJson(reader, new TypeToken<ArrayList<ToeicPartOneQuestion>>() {}.getType());
    ...
    public void update(){
        ...
        this.title.setText("Toeic Part 1 - " + nameSerie);
        this.questionNumber.setText("Question : " + String.valueOf(this.currentQuestion + 1) + "/" + String.valueOf(this.questions.size()));
        this.imageQuestion.setImage(new Image(getClass().getResourceAsStream("saves/imagesQ" + String.valueOf(this.currentQuestion + 1) + ".png")));
        ...
        ImageView image = new ImageView(new Image(getClass().getResourceAsStream("images/play.png")));
        image.setFitHeight(50.0);
        image.setFitWidth(50.0);
        this.playBtn.setGraphic(image);
    }
    ...
    public void playButton(){
        ...
        Media media = new Media(getClass().getResource(questions.get(this.currentQuestion).getPathToSong()).toExternalForm());
    ...
    public void handleEndOfStack(){
        ...
        alert.setOnHidden(evt -> {
            try {
                App.changeToToeicPageView((Stage)this.title.getScene().getWindow());
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
